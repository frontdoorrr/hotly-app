...
def test_url_normalization():
    ...
    url3 = "HTTPS://www.instagram.com/p/ABC123"  # Different scheme case, no trailing slash
    ...
    print(f"   Share same hash suffix: {key1.split(':')[-1] == metadata_key.split(':')[-1] == ai_key.split(':')[-1]}")
