...
from app.schemas.content import PlatformType
...
async def test_content_extractor():
    ...
    try:
        instagram_platform = extractor._detect_platform("https://www.instagram.com/p/ABC123/")
        ...
        youtube_platform = extractor._detect_platform("https://www.youtube.com/watch?v=ABC123")
