...
class TestPerformanceMonitoring:
    ...
    def test_performance_alerting_system(self):
        ...
        # 심각도 체크
        memory_alert = next(a for a in problem_alerts if a["type"] == "high_memory_usage")
...
class TestCacheOptimization:
    ...
    def test_cache_warming_strategy(self):
        ...
        def get_cache_warming_status() -> Dict[str, Any]:
            ...
            return {
                ...
                "warming_rate": len(warmed_keys) / len(popular_keys) if popular_keys else 0
            }
    ...
    def test_cache_compression_optimization(self):
        ...
        compression_ratio = compression_stats["compressed_size"] / compression_stats["original_size"]
    ...
    def test_cache_latency_benchmark(self):
        ...
        def measure_cache_latency(iterations: int = 100):
            ...
            return {
                ...
                "p95_latency": sorted(latencies)[int(0.95 * len(latencies))] if len(latencies) > 1 else latencies[0] if latencies else 0,
