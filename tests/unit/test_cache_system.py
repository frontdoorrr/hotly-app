...
class TestCacheKey:
    ...
    def test_generate_cache_key_basic(self):
        ...
        def generate_cache_key(domain: str, resource_id: str, params: dict = None, version: str = "v1"):
            """캐시 키 생성"""
            if params:
...
class TestMemoryCacheL1:
    ...
    def test_memory_cache_lru_eviction(self):
        ...
        def evict_lru():
            ...
            # 가장 오래 전에 접근된 항목 찾기
            oldest_key = min(cache_metadata.keys(), 
                           key=lambda k: cache_metadata[k]["last_accessed"])
...
class TestDiskCacheL2:
    ...
    def test_disk_cache_file_operations(self):
        ...
        disk_cache = {}
        cache_directory = "/tmp/hotly_cache"
