...
class TestAuthenticatedUserService:
    ...
    def test_update_user_profile(self):
        ...
        try:
            ...
            assert (
                updated_user.is_phone_verified == profile_updates["is_phone_verified"]
            )
    ...
    def test_store_sensitive_data_with_encryption(self):
        ...
        try:
            ...
            stored_data = service.store_sensitive_data(
                user_id=user_id, data_type="payment_info", data_content=sensitive_data
            )
...
class TestUserActivityLogService:
    ...
    def test_log_user_activity(self):
        ...
        activity_data = {"query": "강남 맛집", "results_count": 15, "response_time_ms": 120}
...
class TestUserSettingsService:
    ...
    def test_update_user_settings(self):
        ...
        settings_updates = {
            "theme": "dark",
            "notifications": {"push_enabled": False, "email_enabled": True},
        }
        ...
        try:
            ...
            assert (
                updated_settings.settings_data["notifications"]["push_enabled"] is False
            )
    ...
    def test_setup_privacy_settings(self):
        ...
        try:
            ...
            privacy_settings = service.setup_privacy_settings(
                user_id=user_id, privacy_preferences=privacy_preferences
            )
    ...
    def test_request_data_deletion(self):
        ...
        try:
            ...
            deletion_result = service.request_data_deletion(
                user_id=user_id, reason=deletion_reason, immediate=False  # 30일 후 삭제
            )
