...
class RequestTracer:
    ...
    def add_trace_log(self, trace_id: str, level: str, message: str, extra: Dict = None):
        """추적에 로그 추가"""
        with self._lock:
...
class LogSearchEngine:
    ...
    def add_log_entry(self, level: str, message: str, service: str, extra: Dict = None) -> Dict:
        """로그 항목 추가"""
        with self._lock:
            entry = {
...
class CentralizedLoggingService:
    ...
    def add_trace_log(self, trace_id: str, level: LogLevel, message: str, extra: Dict = None):
        """추적 로그 추가"""
...
def log_info(message: str, trace_id: str = None, user_id: str = None, **kwargs):
    """INFO 레벨 로그"""
    logging_service.log(LogLevel.INFO, message, trace_id=trace_id, user_id=user_id, extra_fields=kwargs)


def log_error(message: str, trace_id: str = None, user_id: str = None, **kwargs):
    """ERROR 레벨 로그"""
    logging_service.log(LogLevel.ERROR, message, trace_id=trace_id, user_id=user_id, extra_fields=kwargs)


def log_warning(message: str, trace_id: str = None, user_id: str = None, **kwargs):
    """WARNING 레벨 로그"""
    logging_service.log(LogLevel.WARNING, message, trace_id=trace_id, user_id=user_id, extra_fields=kwargs)


def log_debug(message: str, trace_id: str = None, user_id: str = None, **kwargs):
    """DEBUG 레벨 로그"""
    logging_service.log(LogLevel.DEBUG, message, trace_id=trace_id, user_id=user_id, extra_fields=kwargs)