...
class SamplePlacesService:
    ...
    def get_sample_places(self, category: Optional[str] = None, limit: int = 10) -> List[Dict[str, Any]]:
    ...
    def get_recommended_samples(self, user_preferences: Dict[str, Any], limit: int = 5) -> List[Dict[str, Any]]:
        ...
        if preferred_categories:
            recommended = [p for p in all_samples if p["category"] in preferred_categories]
        else:
...
class GuideService:
    ...
    def get_onboarding_guide(self, user_id: str, step: Optional[int] = None) -> Dict[str, Any]:
    ...
    def get_feature_guide(self, feature_name: str) -> Dict[str, Any]:
        ...
        return feature_guides.get(feature_name, {
            "title": "기능 가이드",
...
class FirstCourseGuideService:
    ...
    def complete_guide_step(self, user_id: str, guide_id: str, step: int, step_data: Dict[str, Any]) -> Dict[str, Any]:
