...
class PlaceAnalysisService:
    ...
    async def analyze_content(self, content: ContentMetadata, images: List[str] = None) -> PlaceAnalysisResponse:
    ...
    def _calculate_confidence(self, content: ContentMetadata, place_info: PlaceInfo) -> float:
