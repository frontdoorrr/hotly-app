...
async def save_filter_combination(
    *,
    ...
    try:
        ...
        logger.info(f"Saved filter combination '{save_request.name}' for user {current_user.id}")
...
def _convert_to_response_format(result: Dict[str, Any], request: AdvancedFilterRequest) -> Dict[str, Any]:
