...
from app.services.cache_manager import CacheManager, CacheEntry, CacheStats
...
async def test_cache_manager():
    ...
    try:
        ...
        print(f"   First and last same content: {keys[0] == keys[3]}")  # Should be same after normalization
